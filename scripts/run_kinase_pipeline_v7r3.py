...
SCRIPT_CHIMERAX  = "1_run_parallel_chimerax_hmm_v7r3.py"
...
DEFAULT_OUTPUT_FILES = [
    ...
    "hmm_landmarks.json", "hmm_kinase_analysis_results_v7r3.csv",
    "master_kinase_analysis_results_v7r3.csv"
]
...
def main():
    ...
    print("======================================================")
    print("   Kinase Structural Bioinformatic Pipeline v7r3")
    print("======================================================")
    ...
    if run_config:
        if not args.resume:
            ...
            if choice == "2":
                print("\n[*] PAUSED: Review 'generated_matrix.csv'.\n[*] When ready, run: python3 run_kinase_pipeline_v7r3.py --resume")
                sys.exit(0)
        else:
    ...
    merge_csv_results(
        geom_csv="hmm_kinase_analysis_results_v7r3.csv", 
        af3_csv="temp_af3_metrics.csv", 
        final_out_csv="master_kinase_analysis_results_v7r3.csv"
    )

    print("\n======================================================")
    print("   Pipeline Completed!")
    print("   Output: master_kinase_analysis_results_v7r3.csv")
    print("======================================================")
