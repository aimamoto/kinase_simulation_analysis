...
# --- CONFIGURATION ---
WORKER_SCRIPT = os.path.join("modules", "chimerax_hmm_worker_v7r3.py")
FINAL_CSV_NAME = "hmm_kinase_analysis_results_v7r3.csv"
...
def merge_csvs():
    ...
    csv_files = glob.glob("chunk_*_results_v7r3*.csv") + glob.glob(os.path.join(CHUNK_DIR, "chunk_*_results_v7*.csv"))
