...
Usage: python3 1_run_parallel_chimerax_hmm_v4.py -c 24
"""
...
# --- CONFIGURATION ---
WORKER_SCRIPT = os.path.join("modules", "chimerax_hmm_worker_v4r1.py")
FINAL_CSV_NAME = "hmm_kinase_analysis_results_v4r1.csv"
...
def merge_csvs():
    ...
    # Check both the main folder AND the temp folder
    csv_files = glob.glob("*_results.csv") + glob.glob(os.path.join(CHUNK_DIR, "*_results.csv"))
