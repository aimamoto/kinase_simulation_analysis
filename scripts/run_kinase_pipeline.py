...
# We define this as a baseline, but modify it dynamically based on user flags
...
def main():
    ...
    # Determine which files to archive based on user flags
    ...
    run_step("1_run_parallel_chimerax_hmm_v2.py", ["-c", "24"], "Parallel ChimeraX analysis")
